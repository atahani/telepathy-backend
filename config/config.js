...
/**
 * get introduction web site java script fils paths
 */
module.exports.getIntroWebSiteJSPaths = function(){
	var output = this.getGlobbedFiles(this.intro_website.js, 'public/');
	return output;
};

/**
 * get introduction website CSS file paths
 */
module.exports.getIntroWebSiteCSSPaths = function(){
	var output = this.getGlobbedFiles(this.intro_website.css, 'public/');
	return output;
};
